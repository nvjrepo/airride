  ...
  create or replace view `prod`.`warehouse`.`stg_airride__aeroplane_models`
  (
    `aeroplane_model_id` comment 'A unique identifie of the aeroplane model',
	`manufacturer`,
	`model`,
	`max_seats`,
	`max_weight`,
